...
once processed. Whenever the result of an expression, no matter its complexity, is an instance of a
`MarkupNode`, said markup is immediately interpreted and thereby injected into its designated placeholder.
