...
|:-------------------:|:--------------:|:--------------------------------------:|
| bold, b             | `l-me: false`  | Whether to render text bold            |
| italic, i           | `l-me: false`  | Whether to render text italic          |
| underlined, u       | `l-me: false`  | Whether to underline text              |
| strikethrough, st   | `l-me: false`  | Whether to strikethrough text          |
| obfuscated, obf     | `l-me: false`  | Whether to apply the obfuscated effect |
| reset, r            | `l-me: false`  | Whether to apply a [Reset](#reset)     |
