...
<img className='rendered-image' src={useBaseUrl('/img/number_format.png')} />
...
<img className='rendered-image' src={useBaseUrl('/img/number_absolute.png')} />
...
<img className='rendered-image' src={useBaseUrl('/img/number_integer.png')} />
...
<img className='rendered-image' src={useBaseUrl('/img/number_padding.png')} />